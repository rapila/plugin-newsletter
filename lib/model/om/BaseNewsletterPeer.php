...
abstract class BaseNewsletterPeer {
	...
	const CLASS_DEFAULT = 'model.Newsletter';
	...
	{
		// invalidate objects in NewsletterMailingPeer instance pool, since one or more of them may be deleted by ON DELETE CASCADE rule.
	...
	{
		return $withPrefix ? NewsletterPeer::CLASS_DEFAULT : NewsletterPeer::OM_CLASS;
	}
	 ...
	 */
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		try {
			...
			// for more than one table or we could emulating ON DELETE CASCADE, etc.
			$con->beginTransaction();
			$affectedRows += NewsletterPeer::doOnDeleteCascade($criteria, $con);
