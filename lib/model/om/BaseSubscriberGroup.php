...
abstract class BaseSubscriberGroup extends BaseObject  implements Persistent
{
  ...
  const PEER = 'SubscriberGroupPeer';
	 ...
	 * @return     PropelCollection|array NewsletterMailing[] List of NewsletterMailing objects
	 */
	public function getNewsletterMailingsJoinUser($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		$query = NewsletterMailingQuery::create(null, $criteria);
	 ...
	 * @return     void
	 */
	public function initSubscriberGroupMemberships()
	{
	...
	public function clearAllReferences($deep = false)
	{
		if ($deep) {
			...
			if ($this->collSubscriberGroupMemberships) {
				foreach ((array) $this->collSubscriberGroupMemberships as $o) {
					$o->clearAllReferences($deep);
				}
			}
		} // if ($deep)
