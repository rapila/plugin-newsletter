...
/**
 * Base class that represents a row from the 'subscriber_groups' table.
 *
 *
 *
 * @package    propel.generator.model.om
 */
abstract class BaseSubscriberGroup extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'SubscriberGroupPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        SubscriberGroupPeer
     */
    ...
    /**
     * @var        PropelObjectCollection|NewsletterMailing[] Collection to store aggregation of NewsletterMailing objects.
     */
    protected $collNewsletterMailings;
    protected $collNewsletterMailingsPartial;

    /**
     * @var        PropelObjectCollection|SubscriberGroupMembership[] Collection to store aggregation of SubscriberGroupMembership objects.
     */
    protected $collSubscriberGroupMemberships;
    protected $collSubscriberGroupMembershipsPartial;
    ...
    /**
     * Initializes internal state of BaseSubscriberGroup object.
     * @see        applyDefaults()
     */
    ...
    public function setName($v)
    {
        ...
        if ($this->name !== $v) {
            $this->name = $v;
            $this->modifiedColumns[] = SubscriberGroupPeer::NAME;
        }
    ...
    public function setIsDefault($v)
    {
        ...
        if ($this->is_default !== $v) {
            $this->is_default = $v;
            $this->modifiedColumns[] = SubscriberGroupPeer::IS_DEFAULT;
        }
    ...
    public function setDescription($v)
    {
        ...
        if ($this->description !== $v) {
            $this->description = $v;
            $this->modifiedColumns[] = SubscriberGroupPeer::DESCRIPTION;
        }
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->created_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = SubscriberGroupPeer::CREATED_AT;
            }
    ...
    public function setUpdatedAt($v)
    {
        ...
        if ($this->updated_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = SubscriberGroupPeer::UPDATED_AT;
            }
        } // if either are not null
    ...
    public function setCreatedBy($v)
    {
        ...
        if ($this->created_by !== $v) {
            $this->created_by = $v;
            $this->modifiedColumns[] = SubscriberGroupPeer::CREATED_BY;
        }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = SubscriberGroupPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = SubscriberGroupQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($isInsert) {
                ...
                if(Session::getSession()->isAuthenticated()) {
                    if ($this->isModified() && !$this->isColumnModified(SubscriberGroupPeer::UPDATED_BY)) {
                        $this->setUpdatedBy(Session::getSession()->getUser()->getId());
                    }
                }
            }
            if ($ret) {
                ...
                $this->postSave($con);
                SubscriberGroupPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->newsletterMailingsScheduledForDeletion !== null) {
                if (!$this->newsletterMailingsScheduledForDeletion->isEmpty()) {
                    foreach ($this->newsletterMailingsScheduledForDeletion as $newsletterMailing) {
                        // need to save related object because we set the relation to null
                        $newsletterMailing->save($con);
                    }
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = SubscriberGroupPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = SubscriberGroupPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['SubscriberGroup'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['SubscriberGroup'][$this->getPrimaryKey()] = true;
        $keys = SubscriberGroupPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
            $keys[1] => $this->getName(),
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(SubscriberGroupPeer::UPDATED_AT)) $criteria->add(SubscriberGroupPeer::UPDATED_AT, $this->updated_at);
        if ($this->isColumnModified(SubscriberGroupPeer::CREATED_BY)) $criteria->add(SubscriberGroupPeer::CREATED_BY, $this->created_by);
        if ($this->isColumnModified(SubscriberGroupPeer::UPDATED_BY)) $criteria->add(SubscriberGroupPeer::UPDATED_BY, $this->updated_by);
    ...
    {
        $criteria = new Criteria(SubscriberGroupPeer::DATABASE_NAME);
        $criteria->add(SubscriberGroupPeer::ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of SubscriberGroup (or compatible) type.
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        if ($deepCopy && !$this->startCopy) {
            ...
            foreach ($this->getSubscriberGroupMemberships() as $relObj) {
                if ($relObj !== $this) {  // ensure that we don't try to copy a reference to ourselves
                    $copyObj->addSubscriberGroupMembership($relObj->copy($deepCopy));
                }
            }
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return SubscriberGroup Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return SubscriberGroupPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new SubscriberGroupPeer();
        }
    ...
    public function setUserRelatedByCreatedBy(User $v = null)
    {
        ...
        if ($v !== null) {
            $v->addSubscriberGroupRelatedByCreatedBy($this);
        }
    ...
    public function getUserRelatedByCreatedBy(PropelPDO $con = null)
    {
        if ($this->aUserRelatedByCreatedBy === null && ($this->created_by !== null)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aUserRelatedByCreatedBy->addSubscriberGroupsRelatedByCreatedBy($this);
             */
        }
    ...
    public function setUserRelatedByUpdatedBy(User $v = null)
    {
        ...
        // If this object has already been added to the User object, it will not be re-added.
        if ($v !== null) {
            $v->addSubscriberGroupRelatedByUpdatedBy($this);
        }
    ...
    public function getUserRelatedByUpdatedBy(PropelPDO $con = null)
    {
        if ($this->aUserRelatedByUpdatedBy === null && ($this->updated_by !== null)) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aUserRelatedByUpdatedBy->addSubscriberGroupsRelatedByUpdatedBy($this);
             */
        }
    ...
    public function initRelation($relationName)
    {
        ...
        if ('SubscriberGroupMembership' == $relationName) {
    ...
    /**
     * reset is the collNewsletterMailings collection loaded partially
     *
     * @return void
     */
    public function resetPartialNewsletterMailings($v = true)
    {
        $this->collNewsletterMailingsPartial = $v;
    }
     ...
     * If this SubscriberGroup is new, it will return
    ...
    {
        $partial = $this->collNewsletterMailingsPartial && !$this->isNew();
    ...
    public function setNewsletterMailings(PropelCollection $newsletterMailings, PropelPDO $con = null)
    {
        ...
        foreach ($this->newsletterMailingsScheduledForDeletion as $newsletterMailingRemoved) {
            $newsletterMailingRemoved->setSubscriberGroup(null);
        }
    ...
    {
        if ($this->getNewsletterMailings()->contains($newsletterMailing)) {
            $this->collNewsletterMailings->remove($this->collNewsletterMailings->search($newsletterMailing));
            if (null === $this->newsletterMailingsScheduledForDeletion) {
            ...
            $newsletterMailing->setSubscriberGroup(null);
        }
    }
     ...
     * Otherwise if this SubscriberGroup is new, it will return
     * an empty collection; or if this SubscriberGroup has previously
     * been saved, it will retrieve related NewsletterMailings from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in SubscriberGroup.
     *
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param PropelPDO $con optional connection object
     ...
     * @return PropelObjectCollection|NewsletterMailing[] List of NewsletterMailing objects
     */
    public function getNewsletterMailingsJoinNewsletter($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $query = NewsletterMailingQuery::create(null, $criteria);
    ...
    /**
     * Clears out the collSubscriberGroupMemberships collection
     *
     * This does not modify the database; however, it will remove any associated objects, causing
     * them to be refetched by subsequent calls to accessor method.
     *
    ...
    /**
     * reset is the collSubscriberGroupMemberships collection loaded partially
     *
     * @return void
     */
    public function resetPartialSubscriberGroupMemberships($v = true)
    {
        $this->collSubscriberGroupMembershipsPartial = $v;
    }

    /**
     * Initializes the collSubscriberGroupMemberships collection.
     *
     * By default this just sets the collSubscriberGroupMemberships collection to an empty array (like clearcollSubscriberGroupMemberships());
     * however, you may wish to override this method in your stub class to provide setting appropriate
     * to your application -- for example, setting the initial array to the values stored in database.
     *
     * @param boolean $overrideExisting If set to true, the method call initializes
     ...
     * @return void
     */
    public function initSubscriberGroupMemberships($overrideExisting = true)
    {
        if (null !== $this->collSubscriberGroupMemberships && !$overrideExisting) {
            return;
        }
        $this->collSubscriberGroupMemberships = new PropelObjectCollection();
        $this->collSubscriberGroupMemberships->setModel('SubscriberGroupMembership');
    }

    /**
     * Gets an array of SubscriberGroupMembership objects which contain a foreign key that references this object.
     *
     * If the $criteria is not null, it is used to always fetch the results from the database.
     * Otherwise the results are fetched from the database the first time, then cached.
     * Next time the same method is called without $criteria, the cached collection is returned.
     ...
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param PropelPDO $con optional connection object
     * @return PropelObjectCollection|SubscriberGroupMembership[] List of SubscriberGroupMembership objects
     * @throws PropelException
     */
    public function getSubscriberGroupMemberships($criteria = null, PropelPDO $con = null)
    {
        $partial = $this->collSubscriberGroupMembershipsPartial && !$this->isNew();
        if (null === $this->collSubscriberGroupMemberships || null !== $criteria  || $partial) {
            if ($this->isNew() && null === $this->collSubscriberGroupMemberships) {
                // return empty collection
                $this->initSubscriberGroupMemberships();
            } else {
                $collSubscriberGroupMemberships = SubscriberGroupMembershipQuery::create(null, $criteria)
                    ->filterBySubscriberGroup($this)
                    ->find($con);
                if (null !== $criteria) {
                ...
                $this->collSubscriberGroupMemberships = $collSubscriberGroupMemberships;
                $this->collSubscriberGroupMembershipsPartial = false;
            }
        }

        return $this->collSubscriberGroupMemberships;
    }
    ...
    public function setSubscriberGroupMemberships(PropelCollection $subscriberGroupMemberships, PropelPDO $con = null)
    {
        ...
        foreach ($this->subscriberGroupMembershipsScheduledForDeletion as $subscriberGroupMembershipRemoved) {
            $subscriberGroupMembershipRemoved->setSubscriberGroup(null);
        }
     ...
     * @param boolean $distinct
     * @param PropelPDO $con
     * @return int             Count of related SubscriberGroupMembership objects.
     * @throws PropelException
     */
    public function countSubscriberGroupMemberships(Criteria $criteria = null, $distinct = false, PropelPDO $con = null)
    {
        $partial = $this->collSubscriberGroupMembershipsPartial && !$this->isNew();
        if (null === $this->collSubscriberGroupMemberships || null !== $criteria || $partial) {
            if ($this->isNew() && null === $this->collSubscriberGroupMemberships) {
    ...
    {
        if ($this->getSubscriberGroupMemberships()->contains($subscriberGroupMembership)) {
            $this->collSubscriberGroupMemberships->remove($this->collSubscriberGroupMemberships->search($subscriberGroupMembership));
            if (null === $this->subscriberGroupMembershipsScheduledForDeletion) {
            ...
            $subscriberGroupMembership->setSubscriberGroup(null);
        }
    }
     ...
     * Otherwise if this SubscriberGroup is new, it will return
     * an empty collection; or if this SubscriberGroup has previously
     * been saved, it will retrieve related SubscriberGroupMemberships from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in SubscriberGroup.
     ...
     * @return PropelObjectCollection|SubscriberGroupMembership[] List of SubscriberGroupMembership objects
     */
    public function getSubscriberGroupMembershipsJoinSubscriber($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $query = SubscriberGroupMembershipQuery::create(null, $criteria);
        $query->joinWith('Subscriber', $join_behavior);

        return $this->getSubscriberGroupMemberships($query, $con);
    }
     ...
     * @return PropelObjectCollection|SubscriberGroupMembership[] List of SubscriberGroupMembership objects
     */
    public function getSubscriberGroupMembershipsJoinUserRelatedByCreatedBy($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $query = SubscriberGroupMembershipQuery::create(null, $criteria);
        $query->joinWith('UserRelatedByCreatedBy', $join_behavior);
     ...
     * @return PropelObjectCollection|SubscriberGroupMembership[] List of SubscriberGroupMembership objects
     */
    public function getSubscriberGroupMembershipsJoinUserRelatedByUpdatedBy($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $query = SubscriberGroupMembershipQuery::create(null, $criteria);
        $query->joinWith('UserRelatedByUpdatedBy', $join_behavior);
    ...
    {
        return (string) $this->exportTo(SubscriberGroupPeer::DEFAULT_STRING_FORMAT);
    }
