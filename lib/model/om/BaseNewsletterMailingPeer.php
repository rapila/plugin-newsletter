...
abstract class BaseNewsletterMailingPeer {
	...
	const CLASS_DEFAULT = 'model.NewsletterMailing';
	 ...
	 *
	 * @param      NewsletterMailing $value A NewsletterMailing object.
	 * @param      string $key (optional) key to use for instance map (for performance boost if key was already calculated externally).
	 */
	public static function addInstanceToPool(NewsletterMailing $obj, $key = null)
	{
	...
	public static function populateObject($row, $startcol = 0)
	{
		...
		if (null !== ($obj = NewsletterMailingPeer::getInstanceFromPool($key))) {
			...
			$col = $startcol + NewsletterMailingPeer::NUM_COLUMNS;
		} else {
	...
	public static function doSelectJoinAllExceptSubscriberGroup(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		NewsletterPeer::addSelectColumns($criteria);
		$startcol3 = $startcol2 + (NewsletterPeer::NUM_COLUMNS - NewsletterPeer::NUM_LAZY_LOAD_COLUMNS);
	...
	{
		return $withPrefix ? NewsletterMailingPeer::CLASS_DEFAULT : NewsletterMailingPeer::OM_CLASS;
	}

	/**
	 * Method perform an INSERT on the database, given a NewsletterMailing or Criteria object.
	 *
	...
	/**
	 * Method perform an UPDATE on the database, given a NewsletterMailing or Criteria object.
	 *
	...
	/**
	 * Method to DELETE all rows from the newsletter_mailings table.
	 *
	 * @return     int The number of affected rows (if supported by underlying database driver).
	 */
	...
	/**
	 * Method perform a DELETE on the database, given a NewsletterMailing or Criteria object OR a primary key value.
	 *
	 ...
	 */
	public static function doValidate(NewsletterMailing $obj, $cols = null)
	{
		$columns = array();
