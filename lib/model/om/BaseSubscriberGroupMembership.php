  ...
  const PEER = 'SubscriberGroupMembershipPeer';
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 6; // 6 = SubscriberGroupMembershipPeer::NUM_COLUMNS - SubscriberGroupMembershipPeer::NUM_LAZY_LOAD_COLUMNS).
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					...
					$affectedRows += SubscriberGroupMembershipPeer::doUpdate($this, $con);
				}
	...
	public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true, $includeForeignObjects = false)
	{
		...
		if ($includeForeignObjects) {
			if (null !== $this->aSubscriber) {
				$result['Subscriber'] = $this->aSubscriber->toArray($keyType, $includeLazyLoadColumns, true);
			}
	...
	{
		$copyObj->setSubscriberId($this->subscriber_id);
