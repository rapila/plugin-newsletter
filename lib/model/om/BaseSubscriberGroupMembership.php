 ...
 */
abstract class BaseSubscriberGroupMembership extends BaseObject  implements Persistent
{
	 ...
	 * @var        SubscriberGroupMembershipPeer
	 */
	...
	/**
	 * The value for the is_backend_created field.
	 * Note: this column has a database default value of: false
	 * @var        boolean
	 */
	protected $is_backend_created;
	...
	/**
	 * Get the [is_backend_created] column value.
	 * is imported or manually added
	 * @return     boolean
	 */
	public function getIsBackendCreated()
	{
		return $this->is_backend_created;
	}
	...
	public function setSubscriberId($v)
	{
		...
		if ($this->subscriber_id !== $v) {
			...
			$this->modifiedColumns[] = SubscriberGroupMembershipPeer::SUBSCRIBER_ID;
		}
	...
	public function setSubscriberGroupId($v)
	{
		...
		if ($this->subscriber_group_id !== $v) {
			...
			$this->modifiedColumns[] = SubscriberGroupMembershipPeer::SUBSCRIBER_GROUP_ID;
		}
	...
	/**
	 * Sets the value of the [is_backend_created] column.
	 ...
	 * @return     SubscriberGroupMembership The current object (for fluent API support)
	 */
	public function setIsBackendCreated($v)
	{
		if ($v !== null) {
			if (is_string($v)) {
		...
		if ($this->is_backend_created !== $v) {
			$this->is_backend_created = $v;
			$this->modifiedColumns[] = SubscriberGroupMembershipPeer::IS_BACKEND_CREATED;
		}
	...
	public function setCreatedAt($v)
	{
		...
		if ($this->created_at !== null || $dt !== null) {
			...
			if ($currentDateAsString !== $newDateAsString) {
				...
				$this->modifiedColumns[] = SubscriberGroupMembershipPeer::CREATED_AT;
			}
	...
	public function setUpdatedAt($v)
	{
		...
		if ($this->updated_at !== null || $dt !== null) {
			...
			if ($currentDateAsString !== $newDateAsString) {
				...
				$this->modifiedColumns[] = SubscriberGroupMembershipPeer::UPDATED_AT;
			}
		} // if either are not null
	...
	public function setCreatedBy($v)
	{
		...
		if ($this->created_by !== $v) {
			$this->created_by = $v;
			$this->modifiedColumns[] = SubscriberGroupMembershipPeer::CREATED_BY;
		}
	...
	public function setUpdatedBy($v)
	{
		...
		if ($this->updated_by !== $v) {
			$this->updated_by = $v;
			$this->modifiedColumns[] = SubscriberGroupMembershipPeer::UPDATED_BY;
		}
	...
	{
			if ($this->is_backend_created !== false) {
				return false;
			}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->is_backend_created = ($row[$startcol + 3] !== null) ? (boolean) $row[$startcol + 3] : null;
			...
			return $startcol + 8; // 8 = SubscriberGroupMembershipPeer::NUM_HYDRATE_COLUMNS.
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = SubscriberGroupMembershipPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			if ($isInsert) {
				...
				if(Session::getSession()->isAuthenticated()) {
					if ($this->isModified() && !$this->isColumnModified(SubscriberGroupMembershipPeer::UPDATED_BY)) {
						$this->setUpdatedBy(Session::getSession()->getUser()->getId());
					}
				}
			}
			if ($ret) {
				...
				$this->postSave($con);
				SubscriberGroupMembershipPeer::addInstanceToPool($this);
			} else {
				$affectedRows = 0;
			}
			$con->commit();
	...
	protected function doInsert(PropelPDO $con)
	{
		...
		if ($this->isColumnModified(SubscriberGroupMembershipPeer::IS_BACKEND_CREATED)) {
			$modifiedColumns[':p' . $index++]  = '`IS_BACKEND_CREATED`';
		}
		if ($this->isColumnModified(SubscriberGroupMembershipPeer::CREATED_AT)) {
		...
		$sql = sprintf(
			'INSERT INTO `subscriber_group_memberships` (%s) VALUES (%s)',
			...
			foreach ($modifiedColumns as $identifier => $columnName) {
				switch ($columnName) {
					...
					case '`IS_BACKEND_CREATED`':
						$stmt->bindValue($identifier, (int) $this->is_backend_created, PDO::PARAM_INT);
						break;
					case '`CREATED_AT`':
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = SubscriberGroupMembershipPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = SubscriberGroupMembershipPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	public function getByPosition($pos)
	{
		switch($pos) {
			...
			case 2:
				...
				break;
			case 3:
				return $this->getIsBackendCreated();
				break;
			case 4:
	...
	{
		if (isset($alreadyDumpedObjects['SubscriberGroupMembership'][serialize($this->getPrimaryKey())])) {
			return '*RECURSION*';
		}
		$alreadyDumpedObjects['SubscriberGroupMembership'][serialize($this->getPrimaryKey())] = true;
		$keys = SubscriberGroupMembershipPeer::getFieldNames($keyType);
		$result = array(
			$keys[0] => $this->getSubscriberId(),
			$keys[1] => $this->getSubscriberGroupId(),
			$keys[2] => $this->getOptInHash(),
			$keys[3] => $this->getIsBackendCreated(),
	...
	public function setByPosition($pos, $value)
	{
		switch($pos) {
			...
			case 2:
				...
				break;
			case 3:
				$this->setIsBackendCreated($value);
				break;
			case 4:
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[3], $arr)) $this->setIsBackendCreated($arr[$keys[3]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(SubscriberGroupMembershipPeer::IS_BACKEND_CREATED)) $criteria->add(SubscriberGroupMembershipPeer::IS_BACKEND_CREATED, $this->is_backend_created);
		...
		if ($this->isColumnModified(SubscriberGroupMembershipPeer::UPDATED_BY)) $criteria->add(SubscriberGroupMembershipPeer::UPDATED_BY, $this->updated_by);
	...
	{
		$criteria = new Criteria(SubscriberGroupMembershipPeer::DATABASE_NAME);
		$criteria->add(SubscriberGroupMembershipPeer::SUBSCRIBER_ID, $this->subscriber_id);
		$criteria->add(SubscriberGroupMembershipPeer::SUBSCRIBER_GROUP_ID, $this->subscriber_group_id);
	...
	{
		$this->setSubscriberId($keys[0]);
		$this->setSubscriberGroupId($keys[1]);
	}
	...
	{
		return (null === $this->getSubscriberId()) && (null === $this->getSubscriberGroupId());
	}
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of SubscriberGroupMembership (or compatible) type.
	...
	public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
	{
		...
		$copyObj->setIsBackendCreated($this->getIsBackendCreated());
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     SubscriberGroupMembership Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     SubscriberGroupMembershipPeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new SubscriberGroupMembershipPeer();
		}
		return self::$peer;
	}
	 ...
	 * @throws     PropelException
	 */
	public function setSubscriber(Subscriber $v = null)
	{
		if ($v === null) {
		...
		// If this object has already been added to the Subscriber object, it will not be re-added.
		if ($v !== null) {
			$v->addSubscriberGroupMembership($this);
		}
	...
	public function setUserRelatedByCreatedBy(User $v = null)
	{
		...
		if ($v !== null) {
			$v->addSubscriberGroupMembershipRelatedByCreatedBy($this);
		}
	...
	public function setUserRelatedByUpdatedBy(User $v = null)
	{
		...
		// If this object has already been added to the User object, it will not be re-added.
		if ($v !== null) {
			$v->addSubscriberGroupMembershipRelatedByUpdatedBy($this);
		}
