...
abstract class BaseSubscriber extends BaseObject  implements Persistent
{
	...
	/**
	 * @var        array SubscriberGroupMembership[] Collection to store aggregation of SubscriberGroupMembership objects.
	 */
	...
	public function initRelation($relationName)
	{
		if ('SubscriberGroupMembership' == $relationName) {
			return $this->initSubscriberGroupMemberships();
		}
	}
	 ...
	 * @return     PropelCollection|array SubscriberGroupMembership[] List of SubscriberGroupMembership objects
	 * @throws     PropelException
	 */
	public function getSubscriberGroupMemberships($criteria = null, PropelPDO $con = null)
	{
		if(null === $this->collSubscriberGroupMemberships || null !== $criteria) {
