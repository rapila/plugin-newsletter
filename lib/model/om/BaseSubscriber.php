...
/**
 * Base class that represents a row from the 'subscribers' table.
 *
 *
 *
...
abstract class BaseSubscriber extends BaseObject implements Persistent
{
    ...
    /**
     * The value for the preferred_language_id field.
     * @var        string
     */
    protected $preferred_language_id;
    ...
    /**
     * Get the [preferred_language_id] column value.
     *
     * @return string
     */
    ...
    public function setName($v)
    {
        ...
        if ($this->name !== $v) {
            $this->name = $v;
            $this->modifiedColumns[] = SubscriberPeer::NAME;
        }
    ...
    public function setPreferredLanguageId($v)
    {
        ...
        if ($this->preferred_language_id !== $v) {
            $this->preferred_language_id = $v;
            $this->modifiedColumns[] = SubscriberPeer::PREFERRED_LANGUAGE_ID;
        }
    ...
    public function setCreatedBy($v)
    {
        ...
        if ($this->created_by !== $v) {
            $this->created_by = $v;
            $this->modifiedColumns[] = SubscriberPeer::CREATED_BY;
        }
    ...
    public function setUpdatedBy($v)
    {
        ...
        if ($this->updated_by !== $v) {
            $this->updated_by = $v;
            $this->modifiedColumns[] = SubscriberPeer::UPDATED_BY;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->preferred_language_id = ($row[$startcol + 2] !== null) ? (string) $row[$startcol + 2] : null;
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = SubscriberPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = SubscriberQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($isInsert) {
                ...
                // denyable behavior
                if(!(SubscriberPeer::isIgnoringRights() || $this->mayOperate("insert"))) {
                    throw new PropelException(new NotPermittedException("insert.by_role", array("role_key" => "subscribers")));
                }
                ...
                // denyable behavior
                if(!(SubscriberPeer::isIgnoringRights() || $this->mayOperate("update"))) {
                    throw new PropelException(new NotPermittedException("update.by_role", array("role_key" => "subscribers")));
                }
                ...
                if(Session::getSession()->isAuthenticated()) {
                    if ($this->isModified() && !$this->isColumnModified(SubscriberPeer::UPDATED_BY)) {
                        $this->setUpdatedBy(Session::getSession()->getUser()->getId());
                    }
                }
            }
            if ($ret) {
                ...
                $this->postSave($con);
                SubscriberPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        $sql = sprintf(
            'INSERT INTO `subscribers` (%s) VALUES (%s)',
    ...
    public function getByPosition($pos)
    {
        switch ($pos) {
            ...
            case 1:
                ...
                break;
            case 2:
                return $this->getPreferredLanguageId();
                break;
            case 3:
    ...
    public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        $result = array(
            $keys[0] => $this->getId(),
            $keys[1] => $this->getName(),
            $keys[2] => $this->getPreferredLanguageId(),
    ...
    public function setByPosition($pos, $value)
    {
        switch ($pos) {
            ...
            case 1:
                ...
                break;
            case 2:
                $this->setPreferredLanguageId($value);
                break;
            case 3:
                $this->setEmail($value);
                break;
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[2], $arr)) $this->setPreferredLanguageId($arr[$keys[2]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(SubscriberPeer::NAME)) $criteria->add(SubscriberPeer::NAME, $this->name);
        if ($this->isColumnModified(SubscriberPeer::PREFERRED_LANGUAGE_ID)) $criteria->add(SubscriberPeer::PREFERRED_LANGUAGE_ID, $this->preferred_language_id);
        ...
        if ($this->isColumnModified(SubscriberPeer::CREATED_BY)) $criteria->add(SubscriberPeer::CREATED_BY, $this->created_by);
        if ($this->isColumnModified(SubscriberPeer::UPDATED_BY)) $criteria->add(SubscriberPeer::UPDATED_BY, $this->updated_by);
     ...
     * objects.
     *
     * @param object $copyObj An object of Subscriber (or compatible) type.
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        $copyObj->setPreferredLanguageId($this->getPreferredLanguageId());
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return Subscriber Clone of current object.
     * @throws PropelException
     */
    ...
    public function setUserRelatedByCreatedBy(User $v = null)
    {
        ...
        if ($v !== null) {
            $v->addSubscriberRelatedByCreatedBy($this);
        }
    ...
    public function getUserRelatedByCreatedBy(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aUserRelatedByCreatedBy === null && ($this->created_by !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aUserRelatedByCreatedBy->addSubscribersRelatedByCreatedBy($this);
             */
        }
    ...
    public function setUserRelatedByUpdatedBy(User $v = null)
    {
        ...
        // If this object has already been added to the User object, it will not be re-added.
        if ($v !== null) {
            $v->addSubscriberRelatedByUpdatedBy($this);
        }
    ...
    public function getUserRelatedByUpdatedBy(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aUserRelatedByUpdatedBy === null && ($this->updated_by !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aUserRelatedByUpdatedBy->addSubscribersRelatedByUpdatedBy($this);
             */
        }
     ...
     * If this Subscriber is new, it will return
    ...
    protected function doAddSubscriberGroupMembership($subscriberGroupMembership)
    {
        ...
        $subscriberGroupMembership->setSubscriber($this);
    }
     ...
     * Otherwise if this Subscriber is new, it will return
     * an empty collection; or if this Subscriber has previously
     * been saved, it will retrieve related SubscriberGroupMemberships from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in Subscriber.
     *
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param PropelPDO $con optional connection object
     ...
     * @return PropelObjectCollection|SubscriberGroupMembership[] List of SubscriberGroupMembership objects
     */
    public function getSubscriberGroupMembershipsJoinSubscriberGroup($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $query = SubscriberGroupMembershipQuery::create(null, $criteria);
    ...
    public function clear()
    {
        $this->id = null;
        $this->name = null;
        $this->preferred_language_id = null;
        $this->email = null;
    ...
    {
        return (string) $this->exportTo(SubscriberPeer::DEFAULT_STRING_FORMAT);
    }
    ...
    public function mayOperate($sOperation, $oUser = false) {
        ...
        $bIsAllowed = false;
        if($oUser && ($this->isNew() || $this->getCreatedBy() === $oUser->getId()) && SubscriberPeer::mayOperateOnOwn($oUser, $this, $sOperation)) {
            $bIsAllowed = true;
        } else if(SubscriberPeer::mayOperateOn($oUser, $this, $sOperation)) {
            $bIsAllowed = true;
        }
        FilterModule::getFilters()->handleSubscriberOperationCheck($sOperation, $this, $oUser, array(&$bIsAllowed));
        return $bIsAllowed;
    }
