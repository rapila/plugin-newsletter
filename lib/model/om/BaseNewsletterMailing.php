...
/**
 * Base class that represents a row from the 'newsletter_mailings' table.
 *
 *
 *
 * @package    propel.generator.model.om
 */
abstract class BaseNewsletterMailing extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'NewsletterMailingPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        NewsletterMailingPeer
     */
    ...
    /**
     * The value for the date_sent field.
     * @var        string
     */
    protected $date_sent;

    /**
     * The value for the subscriber_group_id field.
     * @var        int
     */
    protected $subscriber_group_id;

    /**
     * The value for the external_mail_group_id field.
     * @var        string
     */
    protected $external_mail_group_id;
    ...
    /**
     * Get the [optionally formatted] temporal [date_sent] column value.
     *
     *
     ...
     */
    public function getDateSent($format = 'Y-m-d H:i:s')
    {
        if ($this->date_sent === null) {
            return null;
        }

        if ($this->date_sent === '0000-00-00 00:00:00') {
        ...
        try {
            $dt = new DateTime($this->date_sent);
        } catch (Exception $x) {
            throw new PropelException("Internally stored date/time/timestamp value could not be converted to DateTime: " . var_export($this->date_sent, true), $x);
        }
    ...
    /**
     * Get the [subscriber_group_id] column value.
     *
     * @return int
     */
    ...
    /**
     * Get the [external_mail_group_id] column value.
     *
     * @return string
     */
    public function getExternalMailGroupId()
    {

        return $this->external_mail_group_id;
    }
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = NewsletterMailingPeer::ID;
        }
    ...
    /**
     * Sets the value of [date_sent] column to a normalized version of the date/time value specified.
     *
     * @param mixed $v string, integer (timestamp), or DateTime value.
     *               Empty strings are treated as null.
     * @return NewsletterMailing The current object (for fluent API support)
     */
    public function setDateSent($v)
    {
        $dt = PropelDateTime::newInstance($v, null, 'DateTime');
        if ($this->date_sent !== null || $dt !== null) {
            $currentDateAsString = ($this->date_sent !== null && $tmpDt = new DateTime($this->date_sent)) ? $tmpDt->format('Y-m-d H:i:s') : null;
            $newDateAsString = $dt ? $dt->format('Y-m-d H:i:s') : null;
            if ($currentDateAsString !== $newDateAsString) {
                $this->date_sent = $newDateAsString;
                $this->modifiedColumns[] = NewsletterMailingPeer::DATE_SENT;
            }
    ...
    public function setSubscriberGroupId($v)
    {
        ...
        if ($this->subscriber_group_id !== $v) {
            $this->subscriber_group_id = $v;
            $this->modifiedColumns[] = NewsletterMailingPeer::SUBSCRIBER_GROUP_ID;
        }

        if ($this->aSubscriberGroup !== null && $this->aSubscriberGroup->getId() !== $v) {
    ...
    /**
     * Set the value of [external_mail_group_id] column.
     *
     * @param  string $v new value
     * @return NewsletterMailing The current object (for fluent API support)
     */
    public function setExternalMailGroupId($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }

        if ($this->external_mail_group_id !== $v) {
            $this->external_mail_group_id = $v;
            $this->modifiedColumns[] = NewsletterMailingPeer::EXTERNAL_MAIL_GROUP_ID;
        }


        return $this;
    } // setExternalMailGroupId()
    ...
    public function setNewsletterId($v)
    {
        ...
        if ($this->newsletter_id !== $v) {
            ...
            $this->modifiedColumns[] = NewsletterMailingPeer::NEWSLETTER_ID;
        }
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->created_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = NewsletterMailingPeer::CREATED_AT;
            }
        } // if either are not null
    ...
    public function setUpdatedAt($v)
    {
        ...
        if ($this->updated_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = NewsletterMailingPeer::UPDATED_AT;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->date_sent = ($row[$startcol + 1] !== null) ? (string) $row[$startcol + 1] : null;
    ...
    public function ensureConsistency()
    {
        ...
        if ($this->aSubscriberGroup !== null && $this->subscriber_group_id !== $this->aSubscriberGroup->getId()) {
            $this->aSubscriberGroup = null;
        }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = NewsletterMailingPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($isInsert) {
                ...
                if (!$this->isColumnModified(NewsletterMailingPeer::UPDATED_AT)) {
                    $this->setUpdatedAt(time());
                }
                // attributable behavior

                if(Session::getSession()->isAuthenticated()) {
                    if (!$this->isColumnModified(NewsletterMailingPeer::CREATED_BY)) {
                        $this->setCreatedBy(Session::getSession()->getUser()->getId());
                    }
                    if (!$this->isColumnModified(NewsletterMailingPeer::UPDATED_BY)) {
                ...
                if(Session::getSession()->isAuthenticated()) {
                    if ($this->isModified() && !$this->isColumnModified(NewsletterMailingPeer::UPDATED_BY)) {
                        $this->setUpdatedBy(Session::getSession()->getUser()->getId());
                    }
                }
            }
            if ($ret) {
                ...
                $this->postSave($con);
                NewsletterMailingPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(NewsletterMailingPeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(NewsletterMailingPeer::DATE_SENT)) {
            $modifiedColumns[':p' . $index++]  = '`date_sent`';
        }
        if ($this->isColumnModified(NewsletterMailingPeer::SUBSCRIBER_GROUP_ID)) {
            $modifiedColumns[':p' . $index++]  = '`subscriber_group_id`';
        }
        if ($this->isColumnModified(NewsletterMailingPeer::EXTERNAL_MAIL_GROUP_ID)) {
            $modifiedColumns[':p' . $index++]  = '`external_mail_group_id`';
        }
        ...
        $sql = sprintf(
            'INSERT INTO `newsletter_mailings` (%s) VALUES (%s)',
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case '`id`':
                        ...
                        break;
                    case '`date_sent`':
                        $stmt->bindValue($identifier, $this->date_sent, PDO::PARAM_STR);
                        break;
                    case '`subscriber_group_id`':
                        $stmt->bindValue($identifier, $this->subscriber_group_id, PDO::PARAM_INT);
                        break;
                    case '`external_mail_group_id`':
                        $stmt->bindValue($identifier, $this->external_mail_group_id, PDO::PARAM_STR);
                        break;
                    case '`newsletter_id`':
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if ($this->aSubscriberGroup !== null) {
                if (!$this->aSubscriberGroup->validate($columns)) {
                    $failureMap = array_merge($failureMap, $this->aSubscriberGroup->getValidationFailures());
                }
            }
            ...
            if (($retval = NewsletterMailingPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = NewsletterMailingPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['NewsletterMailing'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['NewsletterMailing'][$this->getPrimaryKey()] = true;
        $keys = NewsletterMailingPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
            $keys[1] => $this->getDateSent(),
        ...
        if ($includeForeignObjects) {
            if (null !== $this->aSubscriberGroup) {
                $result['SubscriberGroup'] = $this->aSubscriberGroup->toArray($keyType, $includeLazyLoadColumns,  $alreadyDumpedObjects, true);
            }
    ...
    public function setByPosition($pos, $value)
    {
        switch ($pos) {
            ...
            case 2:
                ...
                break;
            case 3:
                $this->setExternalMailGroupId($value);
                break;
            case 4:
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[1], $arr)) $this->setDateSent($arr[$keys[1]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(NewsletterMailingPeer::ID)) $criteria->add(NewsletterMailingPeer::ID, $this->id);
        if ($this->isColumnModified(NewsletterMailingPeer::DATE_SENT)) $criteria->add(NewsletterMailingPeer::DATE_SENT, $this->date_sent);
    ...
    {
        $criteria = new Criteria(NewsletterMailingPeer::DATABASE_NAME);
        $criteria->add(NewsletterMailingPeer::ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of NewsletterMailing (or compatible) type.
    ...
    {
        $copyObj->setDateSent($this->getDateSent());
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return NewsletterMailing Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return NewsletterMailingPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new NewsletterMailingPeer();
        }
     ...
     * @throws PropelException
     */
    public function setSubscriberGroup(SubscriberGroup $v = null)
    {
        if ($v === null) {
            $this->setSubscriberGroupId(NULL);
        } else {
            $this->setSubscriberGroupId($v->getId());
        }

        $this->aSubscriberGroup = $v;

        // Add binding for other direction of this n:n relationship.
        // If this object has already been added to the SubscriberGroup object, it will not be re-added.
        if ($v !== null) {
    ...
    public function clearAllReferences($deep = false)
    {
        if ($deep && !$this->alreadyInClearAllReferencesDeep) {
            ...
            if ($this->aNewsletter instanceof Persistent) {
              $this->aNewsletter->clearAllReferences($deep);
            }
    ...
    public function mayOperate($sOperation, $oUser = false) {
        ...
        if($oUser && ($this->isNew() || $this->getCreatedBy() === $oUser->getId()) && NewsletterMailingPeer::mayOperateOnOwn($oUser, $this, $sOperation)) {
            $bIsAllowed = true;
        } else if(NewsletterMailingPeer::mayOperateOn($oUser, $this, $sOperation)) {
            $bIsAllowed = true;
        }
